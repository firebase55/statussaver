...
import com.AQif.Statusdanwloder.FBVideoPlayerActivity;
...
public class FBHomeFragment extends Fragment {
        ...
        mWebview.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int progress) {
                ...
                if (mprogress.getProgress() < 100) {
                    ...
                    if (currentUrl != null && currentUrl.contains("/stories.php?aftercursorr")) {
                        mWebview.setVisibility(View.INVISIBLE);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_PERMISSION_SETTING && ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
            //Got Permission
    ...
    public void onResume() {
        ...
        if (sentToSettings && ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
            //Got Permission
            Toast.makeText(getActivity(), "Permissions Granted", Toast.LENGTH_LONG).show();
        }
